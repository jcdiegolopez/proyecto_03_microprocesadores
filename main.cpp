...
int main() {
    ...
    int limx1 = 1;           // Borde izquierdo ( un espacio para el borde)
    int limx2 = max_x - 4;   // Borde derecho (considerando 3 caracteres de la nave y 1 más para el borde)
    int limy1 = 2;           // Borde superior (2 líneas de espacio)
    int limy2 = max_y - 3;   // Borde inferior (espacio para la nave y el borde)
